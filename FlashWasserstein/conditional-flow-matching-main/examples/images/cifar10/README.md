...
- For the FlashWasserstein OT-Conditional Flow Matching method:

```bash
python3 train_cifar10.py --model "otcfm" --ot_method "flash" --lr 2e-4 --ema_decay 0.9999 --batch_size 128 --total_steps 400001 --save_step 20000
```
