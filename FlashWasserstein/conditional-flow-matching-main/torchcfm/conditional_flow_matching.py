...
class ExactOptimalTransportConditionalFlowMatcher(ConditionalFlowMatcher):
    ...
    def __init__(self, sigma: Union[float, int] = 0.0, ot_method: str = "exact", **ot_kwargs):
        r"""Initialize the ConditionalFlowMatcher class.
        ...
        It requires the hyper-parameter $\sigma$.
                ...
                ot_kwargs: optional keyword arguments passed to OTPlanSampler.
        """
...
class FlashOptimalTransportConditionalFlowMatcher(ExactOptimalTransportConditionalFlowMatcher):
    """OT-CFM using FlashWasserstein's balanced auction minibatch coupling."""

    def __init__(self, sigma: Union[float, int] = 0.0, **ot_kwargs):
        super().__init__(sigma=sigma, ot_method="flash", **ot_kwargs)
